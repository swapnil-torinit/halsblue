			...
			<div class="box-body">
				...
				<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="email" name="email" value="<?php echo ($this->input->post('email') ? $this->input->post('email') : $admin['email']); ?>"  class="form-control" id="email" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="user_role" class="form-control">
								...
								{
									$selected = ($value == $admin['user_role']) ? ' selected="selected"' : "";
