...
<div class="wrapper">
  <header class="main-header"> 
    ...
    <span class="logo-mini">Hals Blue</span> 
    <!-- logo for regular state and mobile devices --> 
    <span class="logo-lg"><img src="<?php echo base_url();?>resources/img/halslogo.jpg" width="150px"></span> </a> 
...
?>      
      ...
      <ul class="sidebar-menu">
        ...
        <li class="<?php echo ($uri_string == 'report/get_product_sale_report' || $uri_string == 'report/get_sales_report' || $uri_string == 'report/invoice') ? 'active' : '';  ?>"> 
  ...
  <!-- /.content-wrapper -->
  <footer class="main-footer"> <strong>Powered by <a href="https://torinit.com/" target="_blank">Torinit Technologies Pvt Ltd</a></strong> </footer>
