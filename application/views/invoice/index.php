        ...
        <div class="box">
            <div class="box-header">
            	...
            	<div class="box-tools">
                    ...
                    <a href="<?php echo site_url('invoice/index/all'); ?>" class="btn btn-success btn-sm">Show All Invoices</a>
                </div>
            </div>
            <div class="box-body">
...
$counter = 1;
    foreach ($invoices as $i) {
        ...
        ?>
                    <tr>
						<td class="dn"><?php echo $i['id']; ?></td>
						<td><?php if ($i['invoice_no'] != "") {echo $i['invoice_no'];} else {echo $i['id'];}?></td>
						...
						</td><td><a href="<?php echo site_url('common/edit/' . $i['id']); ?>" class="btn btn-info btn-xs">
...
<?php
    ...
    ?>
		<table class="table table-striped" id="invoice_wrapper_ajax">
                	<thead>
	                    <tr>
	                    	<th>InvoiceNo</th>
							<th>Date</th>
