          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="cat_parent" class="form-control">
								...
								<?php 								
								$qu = $this->db->query("select * from categories where status = 1");				
								$cat_parent_values = $qu->result();
								foreach($cat_parent_values as $display_text)
								{
									$selected = ($display_text->id == $this->input->post('cat_parent')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="cat_name" value="<?php echo $this->input->post('cat_name'); ?>" class="form-control" id="cat_name" />
