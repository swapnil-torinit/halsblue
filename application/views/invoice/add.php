<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
	                ...
	                <div class="col-md-6">
	                	<div class="col-md-6">
							...
							<div class="form-group">							
								...
								<?php 
									$all_invoice = $this->Common_model->get_sql_rows('select * from invoices_available_nos');
								?>
								...
								{	
									//$no = explode('/' , $inv->invoice_no);
									echo '<option value="'.$inv->invoice_id.'">'. $inv->invoice_no.'</option>';
								} 
								?>
								</select>
							</div>
                    ...
                    <div class="col-md-6" id="div_customer_id" >
						...
						<div class="form-group">
							<select name="customer_id" class="form-control" id="invoice_customer_id" >
								...
								{	
									echo '<option value="'.$customers->id.'">'.$customers->name.' ('.$customers->company_name.')'.'</option>';
								} 
								?>
							</select>
						</div>
           ...
           <!--  <div class="row clearfix">
            	<div class="col-md-6">
						<label for="qty" class="control-label">Packaging Cost</label>
						<div class="form-group">
							<input  name="packing_cost" value="0" class="form-control">
						</div>
				</div>
				<div class="col-md-6">
						<label for="qty" class="control-label">Tax</label>
						<select name="packing_tax" class="form-control">
								<option value="">--Select One--</option>
								<?php 
