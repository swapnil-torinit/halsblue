                ...
                <table class="table table-striped" id="product_wrapper">
                    ...
                    <tr>
                       ...
                       <td><?php echo $p['sku']; ?></td>
						...
						<td>
                        <div class="col-xs-5"><input type="text" name="current_qty[<?php echo $p['id'];?>]" id="current_qty<?php echo $p['id'];?>" value="<?php echo $p['quantity']; ?>" class="form-control input-sm" disabled>
                        </div>
                        </td>
                        <td>
                        <div class="col-xs-5"><input type="text"  id="add_qty<?php echo $p['id'];?>" name="add_qty[<?php echo $p['id'];?>]" class="form-control input-sm" onChange="updateinventory('<?php echo $p['id'];?>')">
                        </div>
                        </td>	
