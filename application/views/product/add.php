          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="radio" name="product_type" id="product_type_simple" value="0" <?php if($this->input->post('product_type')=='' || $this->input->post('product_type') == 0){ ?> checked="checked" <?php } ?> />&nbsp;Simple&nbsp;&nbsp;&nbsp;&nbsp;
