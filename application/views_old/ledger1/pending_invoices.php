    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Pending Invoicea: (<?=count($invoices);?></h3>            	
            </div>
            <div class="box-body">
                <div class="col-md-6">
                ...
                <table class="table table-striped" id="">
                    ...
                    <tbody>
                    <?php $i = 1; foreach($invoices as $c){
                    $curr_date = date('Y-m-d'); ?>                    
                        <tr class="<?php echo ($c['id']=='pending')?'warning':''; ?>">
                            <td><input type="checkbox" name="inv[]" value="<?=$c['id']?>">
    						<td><?php echo $c['id']; ?></td>
    						<td><?php echo date('d/m/y', strtotime($c['invoice_date'])); ?></td>
                           
                            <td><?php echo isset($c['tax_amount'])?'<i class="fa fa-inr" aria-hidden="true"></i>'.$c['tax_amount']:'-'; ?></td>
