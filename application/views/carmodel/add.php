    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Car model Add</h3>
            </div>            
			<form action="<?php echo base_url(); ?>carmodel/add" method="post" accept-charset="utf-8" enctype="multipart/form-data">            
          	<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="car_make_id" class="form-control">
								...
								{
									$selected = ($car_makes['id'] == $this->input->post('car_make_id')) ? ' selected="selected"' : "";
